    ...
    <>
      ...
      <TextBlock>
        ...
        <ul>
          ...
          <li>Возвращаем до 50 000 руб. при покупке у нас</li>
          <li>Цены напрямую от застройщика</li>
          <li>Вы не платите нам за нашу работу, наши услуги оплачивает застройщик</li>
          <li>Каждому пятому клиенту скидка 60 000 руб.</li>
          <li>Помогаем оформить ипотеку, мы работаем с более двадцати разными банками по ипотеке</li>
        </ul>
